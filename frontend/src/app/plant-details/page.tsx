                ...
                <div className="flex flex-wrap justify-around">
                        <div
                            ...
                            <p className="mb-3 font-normal text-[#2C6E49] group-hover:text-white">
                                In here will be a brief description about watering the plant. This is a placeholder
                                text.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p className="mb-3 font-normal text-[#2C6E49] group-hover:text-white">In here will be a brief description
                                about the amount of sunlight a plant needs. This is a placeholder text.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p className="mb-3 font-normal text-[#2C6E49] group-hover:text-white">In here will be a brief description
                                about the growth rate of the plant. This is a placeholder text.
                            </p>
                        </div>
                        <div
                            className="max-w-sm p-6 mb-5 bg-white border border-gray-200 rounded-lg group hover:bg-[#2C6E49]">
                            ...
                            <p className="mb-3 font-normal text-[#2C6E49] group-hover:text-white">In here will be a brief description
                                about the toxicity of the plant. This is a placeholder text.
                            </p>
                        </div>
                        <div
                            className="max-w-sm p-6 mb-5 bg-white border border-gray-200 rounded-lg group hover:bg-[#2C6E49]">
                            ...
                            <p className="mb-3 font-normal text-[#2C6E49] group-hover:text-white">In here will be a brief description
                                about the maintenance of the plant. This is a placeholder text.
                            </p>
                        </div>
                        <div
                            className="max-w-sm p-6 mb-5 bg-white border border-gray-200 rounded-lg group hover:bg-[#2C6E49]">
                            ...
                            <p className="mb-3 font-normal text-[#2C6E49] group-hover:text-white">In here will be a brief description
                                about the propagation of the plant. This is a placeholder text.
                            </p>
                        </div>
                    </div>
