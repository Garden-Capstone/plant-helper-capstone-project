    ...
    return (
        <>
            ...
            <div className="mx-10 md:container md:mx-auto max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:border-blue-700 ">
                <a href="#">
                    <img className="rounded-t-lg h-72 w-full " src={props.plantcard.image} alt={props.plantcard.imagealt} />
                </a>
                <div className="p-5">
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{props.plantcard.name}</h5>
                    </a>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{props.plantcard.text}</p>
                    <a href="#"
